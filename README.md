...
Welcome to my GitHub profile! I love building full-stack applications using modern web technologies. I enjoy learning, creating, and pushing code that makes an impact.
...
- ✨ Improving my skills on different platforms**
...
| --------------- | -------------------------------------------------- | ------------------- |
| **Smart Deals** | A platform to post and bid on second-hand products | MERN, JWT, Tailwind |
| **Task Flow**   | Team task and project management app               | React, Firebase     |
| **Green Nest**  | Eco-friendly product marketplace                   | MERN, Stripe        |

➡️ More projects in my repos!
...
<a href="https://dev-sourov-dash.vercel.app" target="_blank">
